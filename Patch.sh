...
toilet -f wideterm -F border:gay -t 'Creator @PUNISHER_YT' | lolcat -a -d 1

echo ""

toilet -f mini -F border:gay -t 'PUBG GL PATCHER' | lolcat -a -d 3
...
toilet -f term -F gay '3-> JOIN @PUNISHER_YT on Telegram'
